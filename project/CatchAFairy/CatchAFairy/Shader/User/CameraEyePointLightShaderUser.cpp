//=============================================================================
//	CameraEyePointLightShaderUser.cpp
//
//	カメラ視点ポイントライトシェーダユーザのソースファイル
//
//	Copyright(c) 2019 Ishikawa Takayoshi All Rights Reserved.
//=============================================================================
#include "CameraEyePointLightShaderUser.h"
...
const D3D11_INPUT_ELEMENT_DESC CameraEyePointLight::INPUT_LAYOUT_DESC[INPUT_LAYOUT_COUNT] = {
	{ "SV_POSITION",	0, DXGI_FORMAT_R32G32B32_FLOAT,		0, 0,								D3D11_INPUT_PER_VERTEX_DATA, 0 },
	{ "COLOR",			0, DXGI_FORMAT_R32G32B32A32_FLOAT,	0, D3D11_APPEND_ALIGNED_ELEMENT,	D3D11_INPUT_PER_VERTEX_DATA, 0 },
	{ "TEXCOORD",		0, DXGI_FORMAT_R32G32_FLOAT,		0, D3D11_APPEND_ALIGNED_ELEMENT,	D3D11_INPUT_PER_VERTEX_DATA, 0 }
};
/// <summary>頂点シェーダファイルパス</summary>
const char* const CameraEyePointLight::VERTEX_SHADER_FILEPATH = "Resources\\Shaders\\CameraEyePointLightVertexShader.cso";
/// <summary>ジオメトリシェーダファイルパス</summary>
const char* const CameraEyePointLight::GEOMETRY_SHADER_FILEPATH = "Resources\\Shaders\\CameraEyePointLightGeometryShader.cso";
/// <summary>ピクセルシェーダファイルパス</summary>
const char* const CameraEyePointLight::PIXEL_SHADER_FILEPATH = "Resources\\Shaders\\CameraEyePointLightPixelShader.cso";


/// <summary>
/// デフォルトコンストラクタ
/// </summary>
CameraEyePointLight::CameraEyePointLight() :
...
/// デバイスに読み込まれた
/// </summary>
void CameraEyePointLight::OnDeviceLoaded(){
	// 基底部分を実行
...
ID3D11Buffer* CameraEyePointLight::CreateVertexBuffer(const VSInput* const _vertexArray, unsigned int _vertexCount){
...
void CameraEyePointLight::CreateSamplerState(ID3D11Device* const _device){
	// 設定
...
/// </summary>
/// <param name="_device">デバイス</param>
void CameraEyePointLight::CreateBlendState(ID3D11Device* const _device){
	// レンダーターゲットブレンド設定
...
/// </summary>
/// <param name="_device">デバイス</param>
void CameraEyePointLight::CreateDepthStencilState(ID3D11Device* const _device){
	CD3D11_DEFAULT defaultState;
...
/// </summary>
/// <param name="_device">デバイス</param>
void CameraEyePointLight::CreateRasterizerState(ID3D11Device* const _device){
	CD3D11_DEFAULT defaultState;
...
void CameraEyePointLight::DrawBefore(const OutputResource& _outputResource, const float (&_color)[4]){
	ID3D11DeviceContext* const context = this->GetContext();

	// 出力リソースの初期化
	context->ClearRenderTargetView(_outputResource.pointLightRenderTargetView, _color);
	// カメラ視点1番シェーダのデプスステンシルビューをそのまま使う
//	context->ClearDepthStencilView(_outputResource.depthStencilView, D3D11_CLEAR_DEPTH | D3D11_CLEAR_STENCIL, 1.0f, 0);
	...
	context->OMSetRenderTargets(
		...
		_outputResource.firstDepthStencilView
	);
...
void CameraEyePointLight::Draw(const RenderUseResource& _inputResource){
	ID3D11DeviceContext* const context = this->GetContext();
...
/// 描画後処理
/// </summary>
void CameraEyePointLight::DrawAfter(){
	ID3D11DeviceContext* const context = this->GetContext();
...
/// 定数バッファ配列作成
/// </summary>
void CameraEyePointLight::CreateConstantBufferArray(){
	ID3D11Device* const device = this->GetDevice();
...
/// 定数バッファ配列開放
/// </summary>
void CameraEyePointLight::ReleaseConstantBufferArray(){
	// 一つずつ開放
