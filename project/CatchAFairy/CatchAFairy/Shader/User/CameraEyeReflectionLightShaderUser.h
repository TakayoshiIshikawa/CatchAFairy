//=============================================================================
//	CameraEyeReflectionLightShaderUser.h
//
//	カメラ視点反射光シェーダユーザのヘッダファイル
//
//	Copyright(c) 2019 Ishikawa Takayoshi All Rights Reserved.
//=============================================================================
#pragma once
#ifndef __CAMERA_EYE_REFLECTION_LIGHT_SHADER_USER_H__
#define __CAMERA_EYE_REFLECTION_LIGHT_SHADER_USER_H__
...
namespace CatchAFairy{
	namespace Shader{
		namespace User{
			...
			/// カメラ視点反射光シェーダユーザ
			/// </summary>
			class CameraEyeReflectionLight final : public Base{
			public:
				/// <summary>
				/// 頂点シェーダ入力
				/// </summary>
...
#pragma warning(disable:4201)
					union{
						struct{
							/// <summary>反射光レンダーターゲットビュー</summary>
							ID3D11RenderTargetView* reflectionLightRenderTargetView;
						};
...
#pragma warning(default:4201)
			...
			public:
				// デフォルトコンストラクタ
				CameraEyeReflectionLight();
				// デストラクタ
				virtual ~CameraEyeReflectionLight() override final;
