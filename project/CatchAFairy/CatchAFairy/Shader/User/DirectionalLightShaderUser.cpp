//=============================================================================
//	DirectionalLightShaderUser.cpp
//
//	平行ライトシェーダユーザのソースファイル
//
//	Copyright(c) 2019 Ishikawa Takayoshi All Rights Reserved.
//=============================================================================
#include "DirectionalLightShaderUser.h"
...
const D3D11_INPUT_ELEMENT_DESC DirectionalLight::INPUT_LAYOUT_DESC[INPUT_LAYOUT_COUNT] = {
	{ "SV_POSITION",	0, DXGI_FORMAT_R32G32B32_FLOAT,	0, 0,								D3D11_INPUT_PER_VERTEX_DATA, 0 },
	{ "NORMAL",			0, DXGI_FORMAT_R32G32B32_FLOAT,	0, D3D11_APPEND_ALIGNED_ELEMENT,	D3D11_INPUT_PER_VERTEX_DATA, 0 },
	{ "TEXCOORD",		0, DXGI_FORMAT_R32G32_FLOAT,	0, D3D11_APPEND_ALIGNED_ELEMENT,	D3D11_INPUT_PER_VERTEX_DATA, 0 }
};
/// <summary>頂点シェーダファイルパス</summary>
const char* const DirectionalLight::VERTEX_SHADER_FILEPATH = "Resources\\Shaders\\DirectionalLightVertexShader.cso";
/// <summary>ジオメトリシェーダファイルパス</summary>
const char* const DirectionalLight::GEOMETRY_SHADER_FILEPATH = "Resources\\Shaders\\DirectionalLightGeometryShader.cso";
/// <summary>ピクセルシェーダファイルパス</summary>
const char* const DirectionalLight::PIXEL_SHADER_FILEPATH = "Resources\\Shaders\\DirectionalLightPixelShader.cso";
...
ID3D11Buffer* DirectionalLight::CreateVertexBuffer(const VSInput* const _vertexArray, unsigned int _vertexCount) const {
...
void DirectionalLight::CreateSamplerState(ID3D11Device* const _device){
	// 設定
...
/// </summary>
/// <param name="_device">デバイス</param>
void DirectionalLight::CreateBlendState(ID3D11Device* const _device){
	// ブレンドステート設定
...
/// </summary>
/// <param name="_device">デバイス</param>
void DirectionalLight::CreateDepthStencilState(ID3D11Device* const _device){
	CD3D11_DEFAULT defaultState;
...
/// </summary>
/// <param name="_device">デバイス</param>
void DirectionalLight::CreateRasterizerState(ID3D11Device* const _device){
	CD3D11_DEFAULT defaultState;
...
void DirectionalLight::DrawBefore(const OutputResource& _outputResource, const float (&_color)[4]){
	ID3D11DeviceContext* const context = this->GetContext();

	// 出力リソースの初期化
	context->ClearRenderTargetView(_outputResource.positionRenderTargetView, _color);
...
void DirectionalLight::Draw(const RenderUseResource& _inputResource){
	// 描画するかチェック
	{
...
/// </summary>
/// <param name="_inputResource">入力リソース</param>
void DirectionalLight::DrawMultiple(const MultipleRenderUseResource& _inputResource){
	ID3D11DeviceContext* const context = this->GetContext();
...
/// 描画後処理
/// </summary>
void DirectionalLight::DrawAfter(){
	ID3D11DeviceContext* const context = this->GetContext();
...
/// 定数バッファ配列作成
/// </summary>
void DirectionalLight::CreateConstantBufferArray(){
	ID3D11Device* const device = this->GetDevice();
...
/// 定数バッファ配列開放
/// </summary>
void DirectionalLight::ReleaseConstantBufferArray(){
	// 一つずつ開放
