...
//=============================================================================
#pragma once
#ifndef __OUTPUT_SCREEN_SHADER_USER_H__
#define __OUTPUT_SCREEN_SHADER_USER_H__
...
namespace CatchAFairy{
	namespace Shader{
		namespace User{
			...
			/// 画面出力シェーダユーザ
			/// </summary>
			class OutputScreen final : public Base{
			public:
				/// <summary>
				/// 頂点シェーダ入力
				/// </summary>
			...
			public:
				...
				virtual ~OutputScreen() override final{}
