//=============================================================================
//	PlayCameraEyeFirstShaderUser.h
//
//	プレイカメラ視点1番シェーダユーザのヘッダファイル
//
//	Copyright(c) 2019 Ishikawa Takayoshi All Rights Reserved.
//=============================================================================
#pragma once
#ifndef __PLAY_CAMERA_EYE_FIRST_SHADER_USER_H__
#define __PLAY_CAMERA_EYE_FIRST_SHADER_USER_H__
...
namespace CatchAFairy{
	namespace Shader{
		namespace User{
			...
			/// プレイカメラ視点1番シェーダユーザ
			/// </summary>
			class PlayCameraEyeFirst final : public Base{
			public:
				/// <summary>
				/// 頂点シェーダ入力
				/// </summary>
...
#pragma warning(default:4201)
				...
				struct OutputResource{
					...
					static const unsigned int RENDER_TARGET_COUNT = 3U;
#pragma warning(disable:4201)
					union{
						struct{
							/// <summary>拡散反射レンダーターゲットビュー</summary>
							ID3D11RenderTargetView* diffuseRenderTargetView;
							/// <summary>法線レンダーターゲットビュー</summary>
...
#pragma warning(default:4201)
			...
			public:
				...
				PlayCameraEyeFirst();
				// デストラクタ
				virtual ~PlayCameraEyeFirst() override final;
