//=============================================================================
//	PlayCameraEyeLastShaderUser.h
//
//	プレイカメラ視点最終シェーダユーザのヘッダファイル
//
//	Copyright(c) 2019 Ishikawa Takayoshi All Rights Reserved.
//=============================================================================
#pragma once
#ifndef __PLAY_CAMERA_EYE_LAST_SHADER_USER_H__
#define __PLAY_CAMERA_EYE_LAST_SHADER_USER_H__
...
namespace CatchAFairy{
	namespace Shader{
		namespace User{
			...
			/// プレイカメラ視点最終シェーダユーザ
			/// </summary>
			class PlayCameraEyeLast final : public Base{
			public:
				/// <summary>
				/// 頂点シェーダ入力
				/// </summary>
				...
				struct ConstantBuffer{
					...
					::Ishikawa::Math::Float4 directionalLightColor;
				};
				/// <summary>
				/// 描画利用リソース
				/// </summary>
				struct RenderUseResource{
					...
					static const unsigned int SHADER_RESOURCE_COUNT = 4U;
#pragma warning(disable:4201)
					union{
						struct{
							/// <summary>拡散反射シェーダリソースビュー</summary>
							ID3D11ShaderResourceView* diffuseShaderResourceView;
							/// <summary>影シェーダリソースビュー</summary>
							ID3D11ShaderResourceView* shadowShaderResourceView;
							/// <summary>反射光シェーダリソースビュー</summary>
							ID3D11ShaderResourceView* reflectionLightShaderResourceView;
							/// <summary>ポイントライトシェーダリソースビュー</summary>
							ID3D11ShaderResourceView* pointLightShaderResourceView;
						};
...
#pragma warning(default:4201)
			...
			public:
				...
				PlayCameraEyeLast();
				// デストラクタ
				virtual ~PlayCameraEyeLast() override final;
