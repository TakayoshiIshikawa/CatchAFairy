//=============================================================================
//	PlayGUIShaderUser.cpp
//
//	プレイGUIシェーダユーザのソースファイル
//
//	Copyright(c) 2019 Ishikawa Takayoshi All Rights Reserved.
//=============================================================================
#include "PlayGUIShaderUser.h"
...
const D3D11_INPUT_ELEMENT_DESC PlayGUI::INPUT_LAYOUT_DESC[INPUT_LAYOUT_COUNT] = {
...
const char* const PlayGUI::VERTEX_SHADER_FILEPATH = "Resources\\Shaders\\PlayGUIVertexShader.cso";
/// <summary>ジオメトリシェーダファイルパス</summary>
const char* const PlayGUI::GEOMETRY_SHADER_FILEPATH = "Resources\\Shaders\\PlayGUIGeometryShader.cso";
/// <summary>ピクセルシェーダファイルパス</summary>
const char* const PlayGUI::PIXEL_SHADER_FILEPATH = "Resources\\Shaders\\PlayGUIPixelShader.cso";
...
ID3D11Buffer* PlayGUI::CreateVertexBuffer(const VSInput* const _vertexArray, unsigned int _vertexCount){
...
void PlayGUI::CreateSamplerState(ID3D11Device* const _device){
	// 設定
...
/// </summary>
/// <param name="_device">デバイス</param>
void PlayGUI::CreateBlendState(ID3D11Device* const _device){
	// レンダーターゲットブレンド設定
...
/// </summary>
/// <param name="_device">デバイス</param>
void PlayGUI::CreateDepthStencilState(ID3D11Device* const _device){
	CD3D11_DEFAULT defaultState;
...
/// </summary>
/// <param name="_device">デバイス</param>
void PlayGUI::CreateRasterizerState(ID3D11Device* const _device){
	CD3D11_DEFAULT defaultState;
...
void PlayGUI::Draw(const RenderUseResource& _inputResource){
	ID3D11DeviceContext* const context = this->GetContext();
	...
	// プリミティブトポロジー設定
	context->IASetPrimitiveTopology(ConvertVertexTopologyToD3DPrimitiveTopology(VertexTopology::PointList));
...
/// 定数バッファ配列作成
/// </summary>
void PlayGUI::CreateConstantBufferArray(){
	ID3D11Device* const device = this->GetDevice();
...
/// 定数バッファ配列開放
/// </summary>
void PlayGUI::ReleaseConstantBufferArray(){
	// 一つずつ開放
