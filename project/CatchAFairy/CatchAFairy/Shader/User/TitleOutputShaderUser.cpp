//=============================================================================
//	TitleOutputShaderUser.cpp
//
//	タイトル出力シェーダユーザのソースファイル
//
//	Copyright(c) 2019 Ishikawa Takayoshi All Rights Reserved.
//=============================================================================
#include "TitleOutputShaderUser.h"
...
const D3D11_INPUT_ELEMENT_DESC TitleOutput::INPUT_LAYOUT_DESC[INPUT_LAYOUT_COUNT] = {
	{ "SV_POSITION",	0, DXGI_FORMAT_R32G32_FLOAT,	0, 0,								D3D11_INPUT_PER_VERTEX_DATA, 0 },
	{ "TEXCOORD",		0, DXGI_FORMAT_R32G32_FLOAT,	0, D3D11_APPEND_ALIGNED_ELEMENT,	D3D11_INPUT_PER_VERTEX_DATA, 0 }
};
/// <summary>頂点シェーダファイルパス</summary>
const char* const TitleOutput::VERTEX_SHADER_FILEPATH = "Resources\\Shaders\\TitleOutputVertexShader.cso";
/// <summary>ジオメトリシェーダファイルパス</summary>
const char* const TitleOutput::GEOMETRY_SHADER_FILEPATH = "Resources\\Shaders\\TitleOutputGeometryShader.cso";
/// <summary>ピクセルシェーダファイルパス</summary>
const char* const TitleOutput::PIXEL_SHADER_FILEPATH = "Resources\\Shaders\\TitleOutputPixelShader.cso";
...
ID3D11Buffer* TitleOutput::CreateVertexBuffer(const VSInput* const _vertexArray, unsigned int _vertexCount){
...
void TitleOutput::CreateSamplerState(ID3D11Device* const _device){
	// 設定
...
/// </summary>
/// <param name="_device">デバイス</param>
void TitleOutput::CreateBlendState(ID3D11Device* const _device){
	// レンダーターゲットブレンド設定
...
/// </summary>
/// <param name="_device">デバイス</param>
void TitleOutput::CreateDepthStencilState(ID3D11Device* const _device){
	CD3D11_DEFAULT defaultState;
...
/// </summary>
/// <param name="_device">デバイス</param>
void TitleOutput::CreateRasterizerState(ID3D11Device* const _device){
	CD3D11_DEFAULT defaultState;
...
void TitleOutput::Draw(const RenderUseResource& _inputResource){
	ID3D11DeviceContext* const context = this->GetContext();
...
/// 定数バッファ配列作成
/// </summary>
void TitleOutput::CreateConstantBufferArray(){
	ID3D11Device* const device = this->GetDevice();
...
/// 定数バッファ配列開放
/// </summary>
void TitleOutput::ReleaseConstantBufferArray(){
	// 一つずつ開放
