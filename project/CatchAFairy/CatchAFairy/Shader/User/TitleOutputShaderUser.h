//=============================================================================
//	TitleOutputShaderUser.h
//
//	タイトル出力シェーダユーザのヘッダファイル
//
//	Copyright(c) 2019 Ishikawa Takayoshi All Rights Reserved.
//=============================================================================
#pragma once
#ifndef __TITLE_OUTPUT_SHADER_USER_H__
#define __TITLE_OUTPUT_SHADER_USER_H__
...
namespace CatchAFairy{
	namespace Shader{
		namespace User{
			...
			/// タイトル出力シェーダユーザ
			/// </summary>
			class TitleOutput final : public Base{
			public:
				/// <summary>
				/// 頂点シェーダ入力
				/// </summary>
...
#pragma warning(default:4201)
			...
			public:
				...
				TitleOutput();
				// デストラクタ
				virtual ~TitleOutput() override final;
